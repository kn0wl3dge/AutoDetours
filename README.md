...
- Copy files from the folder executables into the directory C:/Temp of the Win7 VM (using qemu)
- Run the 7z setup executable and keep the default path for installation
